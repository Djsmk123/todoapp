...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    controller.width.value=MediaQuery.of(context).size.width as int;
    return Scaffold(
    ...
    child: Obx(
      ...
      Padding(
      padding:  controller.isMobile.value?const EdgeInsets.all(10): EdgeInsets.fromLTRB(controller.width.value*0.1, 20, controller.width.value*0.08, 20),
      child: Row(
      ...
      child:SizedBox(
      width: controller.width.value*0.7,
      child: Material(
      elevation: 10,
      color: Colors.white,
